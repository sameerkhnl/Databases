...
<body>
	...
	<center>
		<div id="login">
			<h3>Log In</h3>
			<form method="post"
				action="<%=response.encodeUrl(request.getContextPath() + "/Connect?action=createaccount")%>">
				...
				<table>
					...
					<tr>
						...
						<td><input type="password" name="repeatpassword"
							value="<%=request.getAttribute("repeatpassword")==null? "" : request.getAttribute("repeatpassword") %>" /></td>
					</tr>
					<tr>
